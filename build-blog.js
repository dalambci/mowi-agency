    ...
    <div class="header-bar">
      ...
      <nav class="main-nav" id="main-nav" aria-label="Hoofdmenu">
        <ul>
          ...
          <li class="nav-mobile-actions"><a href="/demo" class="btn-primary" data-event="Demo Click">Get a demo</a></li>
        </ul>
      </nav>
  ...
  return `  <footer class="footer-wrap">
    <div class="container">
      ...
      <div class="footer-panel">
        ...
        <!-- "Currently working on" is load-bearing honesty: Mowi does NOT hold
             these marks yet. Never present them as held/certified — the label
             stays until a real certificate exists. -->
        <div class="footer-badges">
          <p class="footer-badges-label">Currently working on</p>
