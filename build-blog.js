...
function buildSitemap(posts) {
  ...
  const staticPages = [
    ...
    // Support Agent product page (2026-09-15, Koers 2026-09 klantcontact-medewerker):
    // the umbrella page for both channels, replacing the retired Product mega-menu.
    "support-agent",
